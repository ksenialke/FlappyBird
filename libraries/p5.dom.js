...
(function(root, factory) {
  ...
  p5.prototype.createSelect = function() {
    ...
    self.option = function(name, value) {
      ...
      if (index !== undefined) {
        ...
        //if it doesn'flappy exist make it
  ...
  // Some browsers partially implement mediaDevices. We can'flappy just assign an object
  ...
  if (navigator.mediaDevices.getUserMedia === undefined) {
    navigator.mediaDevices.getUserMedia = function(constraints) {
      ...
      // Some browsers just don'flappy implement it - return a rejected promise with an error
  ...
  p5.Element.prototype.addClass = function(c) {
    if (this.elt.className) {
      // PEND don'flappy add class more than once
